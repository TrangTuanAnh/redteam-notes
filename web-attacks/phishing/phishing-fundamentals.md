...
Spear phishing nhắm vào CEO, CFO, CISO — người có quyền ra quyết định chiến lược. Giá trị mục tiêu cao hơn → attacker đầu tư nhiều hơn vào research và kịch bản. Email có thể giả mạo luật sư, đối tác kinh doanh, hoặc cơ quan chính phủ.
...
**Lưu ý pháp lý:** Phishing simulation bắt buộc phải có ủy quyền bằng văn bản (scope of engagement) từ tổ chức mục tiêu trước khi thực hiện.
